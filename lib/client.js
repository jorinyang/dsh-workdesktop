...
const ds = (pwb.disposition && (pwb.disposition.summary || pwb.disposition)) || {}
        ...
        const minModalEl = minModal === null ? null : (() => {
          ...
          frows.push(h('input', {
            ...
            placeholder: '如 Work/示例客户A/Output/场次/0913（R7：缺来源锚点的不是事务）',
        ...
        }, panel, matterModalNode, calModalNode, todoModalNode, objModalNode, mmModalNode, trigModalNode, brfModalNode, insModalNode, foModalNode, adModalNode, minModalNode, astModalNode)
      }
